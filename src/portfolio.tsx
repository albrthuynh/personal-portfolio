        ...
        <>
            ...
            >
                ...
                <motion.section
                    ref={aboutRef}
                    id="about"
                    className="py-16 px-4 bg-gradient-to-b from-gray-950 to-black relative"
                ...
                <motion.section
                    ref={experienceRef}
                    id="experience"
                    className="py-16 px-4 bg-gradient-to-b from-black to-gray-950 relative"
                ...
                >
                    <div className="max-w-7xl mx-auto">
                        ...
                        >
                            ...
                            <motion.div
                                className="w-24 h-1 bg-gradient-to-r from-green-500 to-teal-600 mx-auto"
                            ></motion.div>
                        </motion.div>
                        ...
                        >
                            <Card className="bg-gray-900/30 backdrop-blur-xl border-gray-700/40 hover:border-gray-500/60 transition-all duration-500 shadow-2xl hover:shadow-green-500/20">
                                <CardContent className="p-8">
                                    <div className="flex flex-col md:flex-row gap-6">
                                        {/* Left side - Publication info */}
                                        <div className="flex-1">
                                            <h3 className="text-2xl font-semibold text-white mb-2">
                                                CarbonCopies SFN Poster 2025
                                            </h3>
                                            <p className="text-sm text-gray-400 mb-4">Co-Author</p>

                                            <div className="mb-4">
                                                <Badge variant="secondary" className="bg-gray-800 text-white mr-2 mb-2">
                                                    Neuroscience
                                                </Badge>
                                                <Badge variant="secondary" className="bg-gray-800 text-white mr-2 mb-2">
                                                    Brain Emulation
                                            ...
                                            <p className="text-gray-300 mb-6">
                                                Proud to contribute as a co-author to the CarbonCopies Foundation's presentation at the
                                                Society for Neuroscience (SFN) 2025 conference. This poster showcases our work on
                                                brain emulation technology and computational neuroscience research.
                                            </p>
                                        ...
                                        <motion.div
                                            className="md:w-96 h-80 bg-gray-800/50 rounded-lg overflow-hidden cursor-pointer border border-gray-700 hover:border-gray-500 transition-all shadow-lg"
                                            whileHover={{ scale: 1.02 }}
                                            onClick={() => setShowPDF(true)}
                                        >
                                            <iframe
                                                src="/pdfs/SfN2025-Poster-BrainGenix Platform.pdf"
                                                className="w-full h-full pointer-events-none"
                                                title="Poster Preview"
                                            />
                                            <div className="absolute inset-0 bg-black/0 hover:bg-black/10 transition-all flex items-center justify-center">
                                                <div className="opacity-0 hover:opacity-100 transition-opacity bg-black/70 px-4 py-2 rounded-lg">
                ...
                <AnimatePresence>
                    {showPDF && (
                        <PDFViewer
                            pdfUrl="/pdfs/SfN2025-Poster-BrainGenix Platform.pdf"
                            title="CarbonCopies SFN Poster 2025"
